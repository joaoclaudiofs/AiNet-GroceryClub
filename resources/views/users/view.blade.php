<x-layouts.main-content title="View user" heading="Viewing"
                ...
                <div class="flex flex-wrap gap-8">
                    <div class="grow mt-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-4">
                                ...
                                <flux:input :value="$user->name" :label="__('Name')" type="text" required autofocus
                                    autocomplete="name" :placeholder="__('Full name')" 
                                    :disabled="true"/>
                                
                                
                                <flux:radio.group :label="__('Gender')" variant="segmented" size="l" class="w-64"
                                    required
                                    :disabled="true">
                            ...
                            <div class="space-y-4">
                                ...
                                <flux:input :value="$user->email" :label="__('Email address')" type="email" required
                    ...
                    <div class="flex-shrink-0">
                        <div class="pb-6 pe-12">
                            <x-field.image name="photo" label="Photo" width="md" :readonly="true"
